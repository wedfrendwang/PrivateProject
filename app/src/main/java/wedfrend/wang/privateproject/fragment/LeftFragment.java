...
import wedfrend.wang.privateproject.recycle.NewsAdapter;
...
public class LeftFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NewsAdapter newsAdapter = new NewsAdapter(getNews(),LeftFragment.this);
    ...
    private List<News> getNews(){
        ...
        for (int i=0;i<=50;i++){
            ...
            news.setContetnt(getRandomLengthContent("This is news content"+i));
            newsList.add(news);
        }
        return newsList;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(getActivity().findViewById(R.id.news_content_layout)== null || getActivity().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
